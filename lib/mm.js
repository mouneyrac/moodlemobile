...
var MM = {
    ...
    registerForPushNotification: function() {
        ...
        if (MM.getConfig("ios_device_token")) {
            ...
            console.log("I am going to ask my access key");
            ...
            MM.moodleWSCall('message_airnotifier_get_access_key', data, function(result) {
                ...
                var ajaxURL = "http://notify.moodle.net:8801/tokens/" + MM.getConfig("ios_device_token");
                $.ajax({
                    type: "POST",
                    url: ajaxURL,
                    dataType: 'json',
                    ...
                    success: function(response){
                        ...
                        var data = {
                            ...
                            "device[devicename]":'Jerome\'s iPhone'
                        };
                        MM.moodleWSCall('message_airnotifier_add_user_device', data, function(result) {
                            console.log("Device registered on Airnotifier and the Moodle site");
                        });
                    }
                });    
            });
            ...
            ,function(json) {
                if(typeof(json.token) != 'undefined'){
                    ...
                    MM.moodleWSCall('moodle_webservice_get_siteinfo', {}, function(d) {
                        ...
                        MM.registerForPushNotification();
    ...
    panels: {
        ...
        showLoading: function (position) {
            MM.panels.html(position, '<img src="img/loading.gif">');
        },
    ...
    // Check for pending notification and save/display them.
    checkForNotification: function() {
       ...
       pushNotification.getPendingNotifications(function(notifications) {
            ...
            if (notifications.notifications.length > 0) {
                MM.saveAndDisplayNotification(notifications.notifications[0]);
            }
       });
   },

    // Save and display push notification.
    saveAndDisplayNotification: function(notification) {
        var pushNotification = window.plugins.pushNotification;
